const Quote = () => {
  return (
    <div className='flex flex-col justify-center items-center h-96 w-full my-16 bg-[url("./../../public/assets/quote-bg.jpg")] bg-no-repeat bg-center bg-cover'>
      ...
      <div className='w-full flex flex-col justify-center items-center gap-2 mt-4 md:flex-row md:gap-4'>
        <input
          className='w-2/4 h-8 pl-4 rounded-lg text-sm md:w-1/4 md:h-10 md:text-md lg:w-1/5 '
          type='text'
