const Contact = () => {
  return (
    ...
    >
      ...
      <section className='h-screen w-full flex flex-col justify-center items-center md:flex-row md:items-start md:mt-24'>
        <div className='h-1/2 w-full md:h-4/6'>
          <iframe
        ...
        <div className='h-1/2 w-full flex flex-col justify-center items-center px-4 gap-6 md:h-full md:px-0 md:justify-start md:items-center'>
          <input
            className='w-full h-10 pl-4 rounded-md text-sm border border-darkGray md:h-10 md:w-3/4 md:text-md lg:w-2/4'
            type='email'
          ...
          <input
            ...
            placeholder='Email Address'
          />
          <button className='w-full h-10 text-sm bg-purple text-white rounded-md border hover:bg-pinkHover hover:text-white md:h-10 md:w-3/4 lg:w-2/4'>
            Send
          </button>
        </div>
      </section>
