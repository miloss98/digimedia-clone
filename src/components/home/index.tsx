...
const Blog = () => {
  return (
    <section
      id="home"
      className='flex flex-col justify-between items-center h-auto w-full bg-[url("/blog-left-dec.jpg")] bg-no-repeat bg-center px-4 mt-5 md:px-10 md:flex-row md:py-10 lg:px-20'
    >
