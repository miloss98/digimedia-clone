...
const Blog = () => {
  return (
    <section
      id='home'
      className='flex flex-col justify-between items-center h-auto w-full bg-[url("./../../public/assets/blog-left-dec.jpg")] bg-no-repeat bg-cover px-4 mt-5 md:px-10 md:flex-row md:py-20 lg:px-20'
    >
